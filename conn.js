...
const isOwner = [`${setting.ownerNumber}`,"6285173226065@s.whatsapp.net","6282112054951@s.whatsapp.net"].includes(sender) ? true : false
...
"fileName": `FallGnz-Bot ${ngazap(prefix)}`,
...
case 'request': {
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (!q) return reply(`Masukan parameter text\n*Contoh:*\n${prefix+command} Req fitur anu bg`)
...
.then(data => {
var opt = { packname: 'Bot MD', author: 'By FallGnZ' }
